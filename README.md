...
- `demos/opengl/basic_triangle`：OpenGL 入门 demo
...
```bash
sudo apt update
sudo apt install -y build-essential cmake pkg-config libglfw3-dev libglew-dev libgl1-mesa-dev
```
...
可执行文件目标名：`opengl_basic_triangle`
